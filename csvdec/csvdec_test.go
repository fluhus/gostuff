...
func TestReader_basicNoHeader(t *testing.T) {
	tests := []testCase[BasicItem]{
		{"bla,5,6", BasicItem{Stringy: "bla", Inty: 5, Floaty: 6}, false},
		{"bla", BasicItem{}, true},
	}
...
func TestReader_tagged(t *testing.T) {
...
func TestReader_taggedNoHeader(t *testing.T) {
...
func TestReader_missing(t *testing.T) {
...
func TestReader_parseNoHeader(t *testing.T) {
...
func TestReader_sameCol(t *testing.T) {
